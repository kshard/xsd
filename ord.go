...
// const (
// 	OrdAnyURI = xsdAnyURI("ord.xsd.anyuri")
// 	OrdValue  = xsdValue("ord.xsd.value")
// )

// // Type Class ord.Ord[xsd.AnyURI]
// type xsdAnyURI string

// func (xsdAnyURI) Compare(a, b AnyURI) int { return compare(a, b) }
